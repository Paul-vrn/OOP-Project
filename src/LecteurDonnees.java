...
public class LecteurDonnees {
     ...
     */
    public static DonnesSimulation getData(String fichierDonnes) throws FileNotFoundException, DataFormatException {
        LecteurDonnees lecteur = new LecteurDonnees(fichierDonnes);
        //la fonction getCarte qui lit les données de la carte et renvoie une carte
        Carte carte = lecteur.getCarte();
        //TODO la fonction qui get les incendies getIncendies
        //ArrayList<Incendie> incendies = lecteur.getIncendies();
        //TODO la fonction qui get les robots getRobots
        //ArrayList<Robot> robots = lecteur.getRobots();

        return new DonnesSimulation(carte, incendies, robots)
    }
     ...
     */
    private Case.NatureTerrain getNatureTerrain(int lig, int col) throws DataFormatException {
        ignorerCommentaires();
        ...
        try {
            ...
            return Case.NatureTerrain.valueOf(chaineNature);
    ...
    private Robot getRobot() throws DataFormatException {
        ...
        try {
            ...
            if (s == null) {
                return new Robot(Position, type);
            } else {
                int vitesse = Integer.parseInt(s);
                return new Robot(Position, type, vitesse);
            }
